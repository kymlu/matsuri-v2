...
function FormationSectionItem (props: {
  ...
  return <div style={style} ref={setNodeRef} {...attributes} {...listeners}>
    <Button
      ...
      full={full}
      >
      <div className={"flex flex-row items-center w-full h-6 gap-1 min-w-24 " + (full ? "justify-between" : "gap-1 justify-center")}>
